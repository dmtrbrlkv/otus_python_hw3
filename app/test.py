...
class TestFunctional(unittest.TestCase):
    def setUp(self):
        ...
        t = subprocess.Popen(["docker", "exec", "--tty", "mytarantool", "console"], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        self.t = t

        try:
            t.stdin.write("box.space.interests:select({})".encode("utf8"))
